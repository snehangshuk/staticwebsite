...
# Get the instance private IPv4 address from metadata and store it in the $privipv4 variable
  $url = "http://169.254.169.254/latest/meta-data/local-ipv4";
  $privipv4 = file_get_contents($url);
...
<h1>Private IP Address: </h1><h2><?php echo $privipv4; ?></h2>
